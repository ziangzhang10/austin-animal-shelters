...
from pathnames import AustinIncome_url, austin_url, outcome_dataset, intake_dataset, sqldbpath
...
def get_dataset(dbpath):
    # Create the sqlite engine here with a function call. All the tables are in this db. 
    engine = create_db_engine(dbpath)
...
animals_df = get_dataset(sqldbpath)
