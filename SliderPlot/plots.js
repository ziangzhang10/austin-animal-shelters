Plotly.d3.csv('https://raw.githubusercontent.com/AhmedaCheick/csv_store/master/data/breed_data3.csv', function (err, data) {
  console.log(data);
...
//     var byDate, trace;
//     if (!(byDate = lookup[year])) {;
//       byDate = lookup[year] = {};
//     }
// 	 // If a container for this year + continent doesn't exist yet,
// 	 // then create one:
//     if (!(trace = byDate[continent])) {
//       trace = byDate[continent] = {
//         x: [],
//         y: [],
//         id: [],
//         text: [],
